...
A few more concepts will be introduced in later chapters. We will
update the above table as we go.

The spreadsheet system works quite well and everybody eats a healthy
amount of cookies. This is our starting point for learning how
Bitcoin works. We call this version 1.0 of the cookie token
spreadsheet system:
