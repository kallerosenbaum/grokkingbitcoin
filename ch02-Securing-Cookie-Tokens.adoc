...
image::{imagedir}/tool-cryptographic-hash-function.svg[{big-width}]
...
cryptographic hash function we use. You will learn about a few more
different cryptographic hash later in the book as we need them.
