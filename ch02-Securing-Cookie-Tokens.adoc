...
.Familiar padlock
****
image::{imagedir}/web-browser-padlock.png[]
****
...
1. A message to sign, for example `Lisa, please move 10CT to Cafe. /Alice`
2. A private key, which is a huge random number.

To verify a digital signature, you need

1. The message that was signed, for example `Lisa, please move 10CT to Cafe. /Alice`
2. The public key that is generated from the private key
3. The signature
