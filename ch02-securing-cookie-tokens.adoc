...
Digital signatures were briefly mentioned in <<ch01>>, where Alices
...
payement to the cafe with his private key so that Lisa can verify that
...
a key pair and that you have given the public key to Fred.
+
