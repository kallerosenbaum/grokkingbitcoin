...
The transaaction fee will play an important role in this situation
...
.When there is no fee market, transactions don't compete with eachother. They just have to pay for the lost competitiveness.
