...
that it becomes more rare over time due to more efficient transport
mechanisms.
****
...
chain. The _difficulty, d~B~, of a block, B,_ is calculated as

[stem]
++++
d_B=\frac{target\ of\ the\ genesis\ block}{target\ of\ B}=\frac{(2^5-1)*256^{26}}{target\ of\ B}
++++
...
difficulty. So, we sum the difficulties of all blocks to get the
...
****
As of writing, the total hashrate of Bitcoin is about 36
Exahash/s. That's 36*10^18^ hash/s.
****
...
****
As of writing, Bitcoin's 36 Exahash/s are distributed as follows
