...
But once in a while chance is agains odds. Lisa is lucky to find yet
...
more proof of work than the honest branch and switch over to Lisas
...
Look at the column for 36% hashpower, which is what Lisa has. When she
...
.Tom attempts to double spend with 18% hashpower and gives up. He's actually lucky finding two blocks in about the same time the honest miners finds three.
...
all, with 18% of the hashpower he gets almost a fifth of all block
...
try indefinately, their chances are 100% to succeed, see
