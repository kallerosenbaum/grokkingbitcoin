...
miners.
| 3 | 0-1 | Lisa finds a block. If she publishes this block, the other
miners wouldn't confirm the honest transaction because it spends
already spent outputs. She keeps the block secret.
