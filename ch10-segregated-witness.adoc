...
invalidating it. They all involve changing the scriptSig in one way of
...
how the signature is _encoded_ in the scriptSig. There are a few
...
Here all scriptSigs, except the second one is empty. The second
