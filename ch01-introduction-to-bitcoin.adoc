...
traditional bank notes and coins in that way, but it is purely
electronic and used over the Internet. The Bitcoin currency is not
tied to any specific _fiat currency_ like the US dollar or the Chinese
Renminbi; It has free floating exchange rates against all fiat
...
As of 2018, several millions of people are aware of Bitcoin, hundreds
of thousands people are using Bitcoin and thousands of people are
working on developing Bitcoin technology. Bitcoin is primarily used
for payments, savings and speculation today. It removes friction in
on-line payments, especially internationally, and it allows for anyone
to participate in the Bitcoin network without special permission from
a bank or similar institution.

////
==== Who uses Bitcoin?

There are no intended users

Permissionless

We don't know/care

Use cases emerge over time

The dominant use cases today are savings, international payments, and
speculation.

Gold (limited supply)

Anyone with an Internet connection is a potential user of
Bitcoin. Than means that we can't really know who uses it today and
for what purposes. But a good guess is that Bitcoin is used mainly for

* Long term investments
* International payments
* Short term speculation

But the interesting thing about Bitcoin is that no one decides what
Bitcoin should be used for. Use cases emerge as users invent new ways
to use the system. The system doesn't tell you what you may or may not
do with the system; As long as you follow the same rules as everybody
else, you're good to go.
////

////
A lot of more or less interesting use cases have emerged over the
years for Bitcoin. Among the most obvoius ones are international
payments and savings. Just as with any other asset or currency, the
Bitcoin ecosystem has a lot of different users with different needs
and busingesses. These are some common types:

.The Bitcoin network and some of its different users.
...
****
If transactions come in different order, it's very hard to verify if
...
also manages their private keys for them. The private keys are used to
...
privately. In some parts of the world, cash is being phased out, which
means that soon you will not be able to buy a chewing gum without
being recorded by someone.
...
Bitcoin is _permissionless_, which means that you don't need to ask
anyone for permission to participate. Anyone with a computer and an
Internet connection can setup a Bitcoin node and take an active role
...
the recipient can be _sure_ that the money is hers. Once settled,
there is no way of reversing the transfer without the recipient's
consent.
...
speculation causes this volatiliy. But as Bitcoin grows and more
...
economically feasible to pay with ordinary Bitcoin transactions.
