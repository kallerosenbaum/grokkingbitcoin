...
Anyone can participate in the Bitcoin network without special
permission from a bank or similar institution. Thanks to this
_permissionless_ nature of Bitcoin, a lot of Bitcoin related technology
have emerged over the years. Bitcoin participants can be roughly
...
certain tasks.
Bitcoin developers:: People working, usually for free, with the
computer programs that the participants of the Bitcoin network are
running.
...
actors mentioned above can participate actively in the Bitcoin network
