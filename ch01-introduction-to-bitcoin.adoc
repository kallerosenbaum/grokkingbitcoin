...
. The computers in the network check that Alice actually has the money
to spend and that she is authorized to spend them.
...
her _public key_. This is discussed in <<ch02>> and <<ch04>>.
****
...
* the mailbox to move the money from (321)
* the amount to move (1 BTC)
