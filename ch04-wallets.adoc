...
the higher the entropy. For example, suppose an attacker, Mallory,
...
password. If Mallory knows the password length, 8, but not what set of
...
pours in. Great. But what if the Mallory, the gangster, gains access to
...
stolen by Mallory somehow. This may seem harmless because that private
key has so little money in it. But it may be worse than that. If
Mallory has also managed to get the xpub for the on-line sales account
