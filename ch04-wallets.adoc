...
.Release notes, cookie tokens 2.1
|===
|Version|Feature|How
...
|Mobile app "Wallet"
|Simplify backups
|HD wallets are generated from a seed. Only the seed needs to be backed up.
|Create addresses in unsecure environments
|HD wallets lets you 
...
* With hierarchical deterministic wallets, you backup your random seed
  and store that seed in a safe place.
