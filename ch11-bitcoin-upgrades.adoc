...
block in the current retarget period has the following properties:
+
----
timestamp:        2027-12-31 23:59:59
median time past: 2027-12-31 23:59:58
----
+
...
economy choses to run your software?
...
11. In the preveious exercise, your soft fork had support from 80% of
