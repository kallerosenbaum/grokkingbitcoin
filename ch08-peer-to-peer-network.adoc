...
the fourth, and last, transaction of the block.
...
* An estimate of 100,000 BTC, value $630M, being moved daily
* Total mining hashrate is about 50 Ehash/s, 50*10^18^ hash/s. A
  typical desktop computer can do about 25 Mhash/s.
* Transaction fees paid each day totals around 17 BTC. Which averages
  6,800 satoshis per transaction, or 40 cents.
...
hash of that file matches `9d6b...5a4f` exactly. Let's check:
