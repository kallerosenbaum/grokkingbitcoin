...
public key hash encoded in a certain way so that typing errors will be
detected if they occur. At the same time they will make the recipient
even shorter to write for the user.
