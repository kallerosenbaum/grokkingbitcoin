...
the signature is valid. She could verify that the length of the PKH
...
diagrams. The email to Lisa is exactly the same as before. The cookie
...
reasons.
. If the recipient PKH is misspelled in the email to Lisa, when will
that be discovered?
