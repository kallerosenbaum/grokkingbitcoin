...
Suppose that Lisa is about to create a new block at heigh 20. She will
...
image::{imagedir}/bloom-filter-transactions.svg[{fullwidth}]
...
flags and "number of transactions" as they are negligable. The
