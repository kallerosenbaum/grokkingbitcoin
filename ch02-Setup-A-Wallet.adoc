...
This is an awesome, yet-to-be-written, section describing what
cryptographic hash functions are and how they work. Especially one-way
functions will be covered. Hashes and another type of one-way function
are needed when learning about digital signatures.
...
your coworkers use an online spreadsheet to keep track of "cookie
...
This spreadsheet is read-only for everyone except one lady, Lisa. Lisa
is very trustworthy. Everybody trusts her. She has full access to do
whatever she likes with the spreadsheet. You and all the others can
only view the spreadsheet on a web page.
